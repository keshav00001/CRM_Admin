...
import CreateWidgetTemplate from '../../components/CreateWidgetTemplate/CreateWidgetTemplate';
...
const CreateWidget = () => {
    ...
    const saved = localStorage.getItem("html");
    ...
    return (
        <Box className="App">
            <header className="App-header">
                <CreateWidgetTemplate setTemplateCode={setTemplateCode} setTemplateObject={setTemplateObject}></CreateWidgetTemplate>
            </header>

            {templateCode && <Box>
                {/* geting srcDoc from props Data */}
                <iframe srcDoc={templateCode} title='3' width="100%" height="300"></iframe>

                {/* geting srcDoc from Local Storage */}
                <iframe srcDoc={saved} title='3' width="100%" height="300"></iframe>

                {/* for file  */}
                {/* <iframe src='demo.htmk' title='3' width="100%" height="300"></iframe> */}

            </Box>
            }
            {/* <iframe srcdoc={`<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
